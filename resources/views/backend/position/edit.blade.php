    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Position
            ...
            @include('layouts.includes.error')
                ...
                <div class="row"> {!! Form::model($data['position'],['route' => ['position.update',$data['position']->id], 'method' => 'PUT','files' => true]) !!}
                    @csrf
                    @include('backend.position.includes.main_form')
                    <!-- /.box-body -->
                    <div class="col-md-6">
