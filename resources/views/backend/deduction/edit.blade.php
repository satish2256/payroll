    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Deduction
                    <a href="{{route('deduction.index')}}"class="btn btn-info"><i class="fa fa-list"></i>List</a>
            ...
            <div class="box-body">
                ...
                <div class="row"> {!! Form::model($data['deduction'],['route' => ['deduction.update',$data['deduction']->id], 'method' => 'PUT','files' => true]) !!}
                @csrf
                @include('backend.deduction.includes.main_form')
                <!-- /.box-body -->
                    <div class="col-md-6">
